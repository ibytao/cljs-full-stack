...
return (new CustomEvent(event_name,(function (){var obj28359 = {"detail":data};
return obj28359;
})()));
} else {
...
var f = (function (){var pred__28366 = cljs.core._EQ_;
var expr__28367 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28366.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28367))){
return ((function (pred__28366,expr__28367){
return (function (p1__28360_SHARP_){
return console.warn(p1__28360_SHARP_);
});
;})(pred__28366,expr__28367))
} else {
if(cljs.core.truth_(pred__28366.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28367))){
return ((function (pred__28366,expr__28367){
return (function (p1__28361_SHARP_){
return console.debug(p1__28361_SHARP_);
});
;})(pred__28366,expr__28367))
} else {
if(cljs.core.truth_(pred__28366.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28367))){
return ((function (pred__28366,expr__28367){
return (function (p1__28362_SHARP_){
return console.error(p1__28362_SHARP_);
});
;})(pred__28366,expr__28367))
} else {
return ((function (pred__28366,expr__28367){
return (function (p1__28363_SHARP_){
return console.log(p1__28363_SHARP_);
});
;})(pred__28366,expr__28367))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28370){
...
var opts = map__28371__$1;
var eval_fn = cljs.core.get.call(null,map__28371__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28373_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28375,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1527566161265
