...
return (new CustomEvent(event_name,(function (){var obj28561 = {"detail":data};
return obj28561;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25079__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25079__auto__)){
var and__25079__auto____$1 = (window["CustomEvent"]);
...
var args28566 = [];
var len__26199__auto___28572 = arguments.length;
var i__26200__auto___28573 = (0);
while(true){
if((i__26200__auto___28573 < len__26199__auto___28572)){
args28566.push((arguments[i__26200__auto___28573]));

var G__28574 = (i__26200__auto___28573 + (1));
i__26200__auto___28573 = G__28574;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args28566.length)].join('')));
...
var f = (function (){var pred__28569 = cljs.core._EQ_;
var expr__28570 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28569.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28570))){
return ((function (pred__28569,expr__28570){
return (function (p1__28562_SHARP_){
return console.warn(p1__28562_SHARP_);
});
;})(pred__28569,expr__28570))
} else {
if(cljs.core.truth_(pred__28569.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28570))){
return ((function (pred__28569,expr__28570){
return (function (p1__28563_SHARP_){
return console.debug(p1__28563_SHARP_);
});
;})(pred__28569,expr__28570))
} else {
if(cljs.core.truth_(pred__28569.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28570))){
return ((function (pred__28569,expr__28570){
return (function (p1__28564_SHARP_){
return console.error(p1__28564_SHARP_);
});
;})(pred__28569,expr__28570))
} else {
return ((function (pred__28569,expr__28570){
return (function (p1__28565_SHARP_){
return console.log(p1__28565_SHARP_);
});
;})(pred__28569,expr__28570))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28576){
...
var eval_fn = cljs.core.get.call(null,map__28579__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28581_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28583,(0),null);
...
var args28586 = [];
var len__26199__auto___28589 = arguments.length;
var i__26200__auto___28590 = (0);
while(true){
if((i__26200__auto___28590 < len__26199__auto___28589)){
args28586.push((arguments[i__26200__auto___28590]));

var G__28591 = (i__26200__auto___28590 + (1));
i__26200__auto___28590 = G__28591;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__25079__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1485761765878