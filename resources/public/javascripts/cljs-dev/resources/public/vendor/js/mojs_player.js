goog.provide("module$Users$Buck$Projects$cljs_simple$resources$public$vendor$js$mojs_player");
var module$Users$Buck$Projects$cljs_simple$resources$public$vendor$js$mojs_player = {};
module$Users$Buck$Projects$cljs_simple$resources$public$vendor$js$mojs_player["default"] = function(t) {
  function e(i) {
    if (n[i]) {
      return n[i].exports;
    }
  ...
  (function(t, o) {
    ...
    var q = function(t) {
      ...
      return (0, y["default"])(e, t), e.prototype._declareDefaults = function() {
        ...
        var i = this._createChild("div", N[n + "__left"]);
        var o = this._createChild("div", N[n + "__mid"]);
        var r = this._createChild("div", N[n + "__right"]);
        ...
        n || (e = e.timeline || e);
        var i = e instanceof mojs.Tween;
        var o = e instanceof mojs.Timeline;
        if (n || !i && !o) {
        ...
        var e = this._props.isBounds ? this._props.rightBound : 1;
        var n = this._props.isBounds ? this._props.leftBound : -1;
        ...
        var t = this._props;
        var e = t.isBounds ? t.leftBound : t.progress;
        var n = t.progress >= this._getBound("right") ? e : t.progress;
  ...
  var s = n(55);
  var a = i(s);
  var u = "function" == typeof a["default"] && "symbol" == typeof r["default"] ? function(t) {
    return typeof t;
  } : function(t) {
  ...
  t.exports = function(t, e, n, v, m, b, x) {
    ...
    var O = M[c] || M[f] || m && M[m];
    var L = O || k(m);
    var B = m ? C ? k("entries") : L : void 0;
    var j = "Array" == e ? M.entries || O : O;
  ...
  var F = p("symbol-registry");
  var N = p("symbols");
  var q = p("op-symbols");
  var z = Object[D];
  var U = "function" == typeof L;
  var X = i.QObject;
  var H = !X || !X[D] || !X[D].findChild;
  var W = r && l(function() {
  ...
  var V = U && "symbol" == typeof L.iterator ? function(t) {
  ...
  var f = t.exports = {KEY:i, NEED:!1, fastKey:h, getWeak:c, onFreeze:d};
}, function(t, e, n) {
  var i = n(13);
  var o = n(14);
  var r = n(11);
  ...
  var i = n(34);
  var o = n(44).concat("length", "prototype");
  ...
  var i = n(14);
  var o = i.JSON || (i.JSON = {stringify:JSON.stringify});
  t.exports = function(t) {
  ...
  "document" in window.self && ("classList" in document.createElement("_") && (!document.createElementNS || "classList" in document.createElementNS("http://www.w3.org/2000/svg", "g")) ? !function() {
    ...
    if ("Element" in t) {
      ...
      var i = t.Element[n];
      var o = Object;
      var r = String[n].trim || function() {
        return this.replace(/^\s+|\s+$/g, "");
      };
      var s = Array[n].indexOf || function(t) {
  ...
  var g = function(t) {
    ...
    return (0, l["default"])(e, t), e.prototype._declareDefaults = function() {
      ...
      var t = arguments.length <= 0 || void 0 === arguments[0] ? .01 : arguments[0];
      var e = this.track._progress;
  ...
  var _ = function(t) {
    ...
    return (0, l["default"])(e, t), e.prototype._declareDefaults = function() {
      ...
      var e = arguments.length <= 1 || void 0 === arguments[1] ? !0 : arguments[1];
      var n = this._props;
      var i = n.minBound * this._maxWidth;
      var o = n.maxBound * this._maxWidth;
      ...
      var t = this._props;
      var e = "x" === t.direction ? "HORIZONTAL" : "VERTICAL";
      var n = new d["default"].Manager(this.el, {recognizers:[[d["default"].Pan, {direction:d["default"]["DIRECTION_" + e]}]]});
  ...
  !function(o, r, s, a) {
    ...
    function h(t, e, n) {
      ...
      return function() {
        ...
        var n = e && e.stack ? e.stack.replace(/^[^\(]+?[\n$]/gm, "").replace(/^\s+at\s+/gm, "").replace(/^Object.<anonymous>\s*\(/gm, "{anonymous}()@") : "Unknown Stack Trace";
        var r = o.console && (o.console.warn || o.console.log);
    ...
    function E(t) {
      var e;
      var n = t.options.inputClass;
      return new (e = n ? n : Ct ? U : Et ? W : Tt ? V : z)(t, M);
    }
    function M(t, e, n) {
      var i = n.pointers.length;
      var o = n.changedPointers.length;
      var r = e & Dt && i - o === 0;
      var s = e & (Rt | At) && i - o === 0;
    ...
    function O(t, e) {
      ...
      var r = n.firstInput;
      var s = n.firstMultiple;
      var a = s ? s.center : r.center;
      var u = e.center = D(i);
    ...
    function B(t, e) {
      ...
      var o;
      var r;
      var s = t.lastInterval || e;
      var u = e.timeStamp - s.timeStamp;
      if (e.eventType != At && (u > jt || s.velocity === a)) {
        var l = e.deltaX - s.deltaX;
        var p = e.deltaY - s.deltaY;
        var h = I(u, l, p);
    ...
    function $(t) {
      for (var e = t.srcEvent.clientX, n = t.srcEvent.clientY, i = 0; i < this.lastTouches.length; i++) {
        ...
        var r = Math.abs(e - o.x);
        var s = Math.abs(n - o.y);
        if (ae >= r && ae >= s) {
          return !0;
        }
      }
    ...
    var _t;
    var gt = ["", "webkit", "Moz", "MS", "ms", "o"];
    var yt = r.createElement("div");
    var vt = "function";
    var mt = Math.round;
    var bt = Math.abs;
    var xt = Date.now;
    ...
    var Pt = 1;
    var kt = /mobile|tablet|ip(ad|hone|od)|android/i;
    var Tt = "ontouchstart" in o;
    var Ct = P(o, "PointerEvent") !== a;
    var Et = Tt && kt.test(navigator.userAgent);
    var Mt = "touch";
    var Ot = "pen";
    var Lt = "mouse";
    var Bt = "kinect";
    ...
    var Zt = {mousedown:Dt, mousemove:It, mouseup:Rt};
    var Gt = "mousedown";
    var $t = "mousemove mouseup";
    ...
    var Jt = {pointerdown:Dt, pointermove:It, pointerup:Rt, pointercancel:At, pointerout:At};
    var Kt = {2:Mt, 3:Ot, 4:Lt, 5:Bt};
    var Qt = "pointerdown";
    var te = "pointermove pointerup pointercancel";
    o.MSPointerEvent && !o.PointerEvent && (Qt = "MSPointerDown", te = "MSPointerMove MSPointerUp MSPointerCancel"), c(U, C, {handler:function(t) {
      ...
      var o = Jt[i];
      var r = Kt[t.pointerType] || t.pointerType;
      var s = r == Mt;
      var a = x(e, t.pointerId, "pointerId");
    ...
    var ee = {touchstart:Dt, touchmove:It, touchend:Rt, touchcancel:At};
    var ne = "touchstart";
    var ie = "touchstart touchmove touchend touchcancel";
    ...
    var oe = {touchstart:Dt, touchmove:It, touchend:Rt, touchcancel:At};
    var re = "touchstart touchmove touchend touchcancel";
    ...
    tt.prototype = {defaults:{}, set:function(t) {
      ...
      var e = this.options;
      var n = t.pointers.length === e.pointers;
      var i = t.distance < e.threshold;
      var o = t.deltaTime > e.time;
      ...
      if (i && o && n) {
        ...
        var s = !this.pCenter || A(this.pCenter, t.center) < e.posThreshold;
  ...
  function o(t) {
    for (var e = [], n = {}, i = 0; i < t.length; i++) {
      ...
      var a = o[2];
      var u = o[3];
      var l = {css:s, media:a, sourceMap:u};
  ...
  var g = function(t) {
    ...
    return (0, l["default"])(e, t), e.prototype._declareDefaults = function() {
      ...
      var e = this._props;
      var n = "x" === e.direction ? t.layerX : t.layerY;
  ...
  var c = function(t) {
    ...
    return (0, l["default"])(e, t), e.prototype._declareDefaults = function() {
      ...
      var e = null != t.offsetX ? t.offsetX : t.layerX;
      var n = null != t.offsetY ? t.offsetY : t.layerY;
  ...
  var f = function(t) {
    ...
    return (0, l["default"])(e, t), e.prototype._declareDefaults = function() {
      ...
      var t = this._props;
      var e = document.createElementNS(this.NS, "svg");
      var n = '\x3cuse xlink:href\x3d"#' + t.prefix + t.shape + '-icon-shape" /\x3e';
      e.setAttribute("viewBox", "0 0 32 32"), this._addSVGHtml(e, n), this.el.appendChild(e);
    }, e.prototype._addSVGHtml = function(t, e) {
      var n = this._createElement("div");
      var i = "\x3csvg\x3e " + e + " \x3c/svg\x3e";
      n.innerHTML = i;
  ...
  var y = function(t) {
    ...
    return (0, l["default"])(e, t), e.prototype._declareDefaults = function() {
      ...
      var e = this._progressToSpeed(t).toFixed(2);
      var n = /\.+00$/;
  ...
  var _ = function(t) {
    ...
    return (0, l["default"])(e, t), e.prototype._declareDefaults = function() {
      ...
      var e = this._props;
      var n = new h["default"]({parent:this.el, shape:e.icon, size:e.iconSize, className:f.icon, prefix:e.prefix});
