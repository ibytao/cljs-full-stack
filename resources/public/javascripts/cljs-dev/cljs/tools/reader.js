...
var G__26935 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26935;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26936 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26936,ch);
...
if(("\\" === ch__$1)){
var ch_26937__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26937__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26937__$2);
} else {
}

var G__26938 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26938;
continue;
}
}
...
var vec__26946 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26946,(0),null);
var start_column = cljs.core.nth.call(null,vec__26946,(1),null);
...
var G__26949 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26949;
continue;
}
}
...
var _STAR_read_delim_STAR_26950 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_26950;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26951 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26951,(0),null);
var start_column = cljs.core.nth.call(null,vec__26951,(1),null);
...
var vec__26954 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26954,(0),null);
var end_column = cljs.core.nth.call(null,vec__26954,(1),null);
...
var vec__26957 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26957,(0),null);
var start_column = cljs.core.nth.call(null,vec__26957,(1),null);
...
var vec__26960 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26960,(0),null);
var end_column = cljs.core.nth.call(null,vec__26960,(1),null);
...
var vec__26963 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26963,(0),null);
var start_column = cljs.core.nth.call(null,vec__26963,(1),null);
...
var vec__26966 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26966,(0),null);
var end_column = cljs.core.nth.call(null,vec__26966,(1),null);
...
switch (G__26975) {
case "\\":
var G__26979 = (function (){var G__26976 = sb;
G__26976.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26976;
})();
var G__26980 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26979;
ch = G__26980;
continue;
...
break;
default:
var G__26981 = (function (){var G__26977 = sb;
G__26977.append(ch);

return G__26977;
})();
var G__26982 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26981;
ch = G__26982;
continue;
...
var vec__26983 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26983,(0),null);
var end_column = cljs.core.nth.call(null,vec__26983,(1),null);
...
var vec__26986 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var line = cljs.core.nth.call(null,vec__26991,(0),null);
var column = cljs.core.nth.call(null,vec__26991,(1),null);
...
var vec__26996 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26996,(0),null);
var column = cljs.core.nth.call(null,vec__26996,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27001 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27001,(0),null);
var start_column = cljs.core.nth.call(null,vec__27001,(1),null);
...
var vec__27004 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27004,(0),null);
var end_column = cljs.core.nth.call(null,vec__27004,(1),null);
...
var G__27007 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27007,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_27009 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27009;
}});
...
var G__27010 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27010,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27010,rdr,first_line);
...
var G__27014 = matched;
var G__27015 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27014;
finished = G__27015;
continue;
} else {
...
var arg_env27017 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27018 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27018,"(");
...
var G__27019 = (i + (1));
var G__27020 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env27017;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27021 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27021);
...
var G__27022 = cljs.core.next.call(null,s__$1);
var G__27023 = ret;
s__$1 = G__27022;
r = G__27023;
continue;
...
var G__27024 = cljs.core.next.call(null,s);
var G__27025 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27024;
key_vals = G__27025;
continue;
} else {
...
var gensym_env27029 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env27029;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27030 = token;
var G__27030__$1 = (((G__27030 == null))?null:cljs.core.subs.call(null,G__27030,(1)));
var G__27030__$2 = (((G__27030__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27030__$1));
var G__27030__$3 = (((G__27030__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27030__$2));
var G__27030__$4 = (((G__27030__$3 == null))?null:cljs.core.symbol.call(null,G__27030__$3));
if((G__27030__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27030__$4);
}
})():(function (){var G__27031 = token;
var G__27031__$1 = (((G__27031 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27031));
if((G__27031__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27031__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27042,reader){
...
var eof = cljs.core.get.call(null,map__27043__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___27051 = arguments.length;
var i__4500__auto___27052 = (0);
while(true){
if((i__4500__auto___27052 < len__4499__auto___27051)){
args__4502__auto__.push((arguments[i__4500__auto___27052]));

var G__27053 = (i__4500__auto___27052 + (1));
i__4500__auto___27052 = G__27053;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27049){
var G__27050 = cljs.core.first.call(null,seq27049);
var seq27049__$1 = cljs.core.next.call(null,seq27049);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27050,seq27049__$1);
});


//# sourceMappingURL=reader.js.map?rel=1527566158968
