...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25697__auto__,writer__25698__auto__,opt__25699__auto__){
return cljs.core._write.call(null,writer__25698__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__26755 = o;
(G__26755[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__25079__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25079__auto__){
var and__25079__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__26764 = jsprops;
(G__26764["defaultValue"] = value);

(G__26764["onChange"] = ((function (G__26764,v,value,on_change){
return (function (p1__26761_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26761_SHARP_);
});})(G__26764,v,value,on_change))
);

(G__26764["ref"] = ((function (G__26764,v,value,on_change){
return (function (p1__26762_SHARP_){
return (this$["cljsInputElement"] = p1__26762_SHARP_);
});})(G__26764,v,value,on_change))
);
...
var vec__26771 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26771,(0),null);
var id = cljs.core.nth.call(null,vec__26771,(1),null);
var class$ = cljs.core.nth.call(null,vec__26771,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26776 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26776 == null)){
} else {
var key_26777 = temp__4661__auto___26776;
(jsprops["key"] = key_26777);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26779 = (new reagent.impl.template.NativeWrapper());
(G__26779["name"] = c);
...
var len__26199__auto___26785 = arguments.length;
var i__26200__auto___26786 = (0);
while(true){
if((i__26200__auto___26786 < len__26199__auto___26785)){
args__26206__auto__.push((arguments[i__26200__auto___26786]));

var G__26787 = (i__26200__auto___26786 + (1));
i__26200__auto___26786 = G__26787;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26207__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26783){
var G__26784 = cljs.core.first.call(null,seq26783);
var seq26783__$1 = cljs.core.next.call(null,seq26783);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26784,seq26783__$1);
});
...
break;
default:
var G__26791 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26791;
continue;
...
var n__26009__auto___26794 = a.length;
var i_26795 = (0);
while(true){
if((i_26795 < n__26009__auto___26794)){
(a[i_26795] = reagent.impl.template.as_element.call(null,(a[i_26795])));
...
var a = cljs.core.into_array.call(null,s);
var n__26009__auto___26797 = a.length;
var i_26798 = (0);
while(true){
if((i_26798 < n__26009__auto___26797)){
var val_26799 = (a[i_26798]);
if((cljs.core.vector_QMARK_.call(null,val_26799)) && ((reagent.impl.template.key_from_vec.call(null,val_26799) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26798] = reagent.impl.template.as_element.call(null,val_26799));

var G__26800 = (i_26798 + (1));
i_26798 = G__26800;
continue;
} else {
}
...
var ctx = ({});
var vec__26804 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26804,(0),null);
var derefed = cljs.core.nth.call(null,vec__26804,(1),null);
...
var G__26808 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26808) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26808){
...
//# sourceMappingURL=template.js.map?rel=1485761761972