...
goog.require('module$resources$public$vendor$js$calculator');
goog.require('module$resources$public$vendor$js$mojs_player');
goog.require('reagent.core');
cljs.core.enable_console_print_BANG_.call(null);
cljs.core.println.call(null,module$resources$public$vendor$js$calculator.add.call(null,(4),(5)));
cljs_simple.mojs_animation.translate_y = (function cljs_simple$mojs_animation$translate_y(node){
return (function (progress){
return node.style.transform = [cljs.core.str("translateX("),cljs.core.str(((200) * progress)),cljs.core.str("px)")].join('');
});
});
...
return (new module$resources$public$vendor$js$mojs_player.mojs_player(cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"add","add",235287739),squarel], null))));
});
...
//# sourceMappingURL=mojs_animation.js.map?rel=1485862919067